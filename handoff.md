...
> 마지막 업데이트: 2026-05-28 KST (✅ v2.19.11 — #74 후속 `_ALLOWED_DATE_FIELDS` qi_start + si_start 추가. BE 1줄 / VIEW v1.53.0 prod 배포 후 사용자 catch — Phase 1 QI/SI 카드 카운트 0 (400 INVALID_DATE_FIELD). factory.py 화이트리스트 누락 fix. pytest 11/11 PASS. Railway 자동 배포 trigger.
