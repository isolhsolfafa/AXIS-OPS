...
- **OPS BE**: v2.18.17 (2026-05-22, Sentry 잡음 2건 fix — events.py + email_service.py + auth_service.py)
- **OPS FE (Flutter PWA)**: v2.18.17 (2026-05-22, version bump only)
- **최근 release**: v2.18.17 Sentry 잡음 fix — WebSocket BrokenPipeError → INFO + SMTPRecipientsRefused → WARNING. v2.10.13 패턴 정합. 운영 catch: admin 이메일 점검 부탁
