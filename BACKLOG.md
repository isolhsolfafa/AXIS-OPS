...
| 52-BF | TM 체크리스트 FE 키 불일치 + checklistReady 자동 전환 | ✅ 수정 완료 (2026-04-02) | group→group_name, check_name→item_name, id→master_id 7곳 + completeTask Record 리턴 + 체크리스트 자동 push |
