...
> **현재 버전**: **v2.15.6 (HOTFIX-SPRINT41D-TMS-CLOSE-FIX-MECH-ELEC-PROGRESS-100 — TMS 잘못 매핑 정정 + (나) 옵션, 2026-05-14)** — BE only / TM/TMS PRESSURE_TEST complete = close (체크리스트 무관) + MECH/ELEC task progress 100% AND + checklist_pending forward (Codex M-1 v2.15.5 정정) / pytest 38/38 GREEN / commit `97a02f9` / 회귀 위험 0
