...
> **현재 버전**: **v2.38.2 (Sprint 91-FE 연장 — 퇴근 다이얼로그 [모두 내작업완료], 2026-06-13)** — FE only. 실기기 QA(일시정지 ✅) 후 추가: completeTask(finalize=false) 순차 + 실패 안내. Sprint 번호 부여(90-BE-D/91/91-FE). 공지 117. Netlify prod. **⏭️ 다음**: VIEW 수정 6건(데이터종합 툴팁/B5/#91 툴팁/#90 비교 실데이터/커버리지 연동) / #87 Phase 2b.
