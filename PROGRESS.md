...
> **현재 버전**: **v2.15.12 (FIX-MECH-CHECKLIST-PROGRESS-REALTIME-AND-STICKY — 실시간 갱신 + 스크롤 고정, 2026-05-15)** — FE only 1 파일 / 라디오 onTap 영역 item['check_result'] 동기화 + ListView 외부 Column wrap (스크롤 고정) / 회귀 위험 0
