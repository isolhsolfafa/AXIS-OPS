...
> **현재 버전**: **v2.18.1 (Sprint 69 fix: 내 작업 완료 다이얼로그 공정명 하드코딩, 2026-05-19)** — FE only 1줄(gst_products_screen.dart) / `_completeMyWork()` 확인 다이얼로그 `'SI 마무리공정'` 하드코딩 → `$_categoryLabel` (PI/QI 에서도 정확) / flutter build GREEN / 회귀 0
