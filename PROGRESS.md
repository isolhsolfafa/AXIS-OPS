...
> **현재 버전**: **v2.39.0 (Sprint 90-BE-C-b / #90b — close-type-trend 주별 ISO week 버킷, 2026-06-13)** — BE only additive. `?bucket=week`(기본 month back-compat) ISO 라벨+meta.bucket+주 zero-fill. Codex R1 DEPLOY_SAFE M=0. pytest 9/9. VIEW [주|월] 토글 자동 전환. **⏭️ 다음**: VIEW 수정 잔여 / #87 Phase 2b / 설계서 분할.
