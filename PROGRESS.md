...
> **현재 버전**: **v2.13.2 (HOTFIX-TASKS-BY-ORDER-WORKERS — workers 배열 추가, S1 동반, 2026-05-11)** — BE only patch (~110 LoC) / VIEW v1.43.6 S1 HOTFIX 동시 / POST-REVIEW deadline 2026-05-12 / 회귀 위험 0
