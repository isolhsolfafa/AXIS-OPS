...
> **현재 버전**: **v2.25.1 (Sprint 83 공정 순서 정정 — 반제품 선행, 2026-06-05)** — v2.25.0 cascade tier 순서 정정 (반제품 TM 을 기구/전장과 병렬→선행). 실 순서: 전장외부→반제품→기구→전장→가압→공정→마무리. 후속 공정 도달 시 반제품 강제 100% (W23 tm 83.9→100.0). pytest 11 GREEN(CR-11 신규).
