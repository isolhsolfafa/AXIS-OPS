...
> **현재 버전**: **v2.15.17 (FIX-VIEW-ORPHAN-DURATION-MISSING, 2026-05-15)** — BE 2 파일 + pytest 1 / Trigger task auto-close 시 VIEW 소요시간 '—' 미표시 fix (work.py + task_service_batch.py SQL COALESCE fallback) / Codex 라운드 1 M=2 반영 / pytest 10/10 GREEN / 회귀 위험 0
