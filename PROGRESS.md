...
> **현재 버전**: **v2.15.16 (SPRINT-V2-15-16-MECH-FORCE-CLOSED-PREV-DAY-CAP, 2026-05-15)** — BE 3 파일 + migration 1 + pytest 1 / 사용자 운영 catch 3건 fix (MECH Phase 1+2 합산 + force_closed=False 통일 5곳 + PREV_DAY_CAP) / Codex 라운드 1 M=5 전수 반영 / pytest 50/50 GREEN (신규 12 + 회귀 38) / 회귀 위험 0
