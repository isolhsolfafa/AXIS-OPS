...
> **현재 버전**: **v2.14.0 (Sprint 66-BE-FOLLOWUP v3 — 자재 마스터 Excel 일괄 업로드 endpoint, 2026-05-12)** — BE only minor (~544 LoC + 24 TC) / Codex 5라운드 검증 (M=4→0 GREEN) / pytest 23/23 GREEN / 회귀 위험 0
