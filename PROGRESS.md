...
> **현재 버전**: **v2.15.9 (HOTFIX-SPRINT41D-PROGRESS-100-REVERT-AND-LABEL-CHANGE — (나) → (가) 회귀 + "공정 마감" 라벨, 2026-05-14)** — BE 1 + FE 2 파일 / v2.15.6 (나) 옵션 catch 후 v2.15.5 close 조건 회귀 + 다이얼로그 라벨 변경
