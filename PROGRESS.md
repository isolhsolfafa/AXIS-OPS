...
> **현재 버전**: **v2.14.2 (HOTFIX-MATERIALS-CATEGORY-ILIKE — 자재 마스터 검색 case-insensitive, 2026-05-13)** — BE only patch / `/api/admin/materials?category=` `=` → `ILIKE` 부분 매칭 / 3 line + pytest TC 2건 신규 / 15/15 PASS / 회귀 위험 0
