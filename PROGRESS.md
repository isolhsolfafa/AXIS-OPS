...
> **현재 버전**: **v2.19.0 (Sprint 79 FEAT-SI-SHIPMENT-FLOW-3PHASE, 2026-05-27)** — 큰 sprint / SI 마무리공정 TabBar 3개 (미종료/출하 확정/출하 예정) + admin 메인 메뉴 분리 (비활성 사용자 + 미종료 작업 분류) + 매일 07:30 KST 출하 미처리 자동 알림. BE 신규 2 + 수정 4 / FE 신규 3 + 수정 2 / pytest 14/14 PASS / Codex 라운드 1 (M=7/A=2/N=4) 모두 반영 (사용자 결정 Q8 (나) overlap / M2 현행 / A-추가1 (가)).
