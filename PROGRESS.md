...
> **현재 버전**: **v2.15.3 (HOTFIX-SPRINT41D-AUTO-FINALIZE-RANGE-EXTENSION — Issue A 차단 범위 확장, 2026-05-14)** — BE only / `AUTO_FINALIZE_BLOCKED_TASK_IDS` 11 task Allowlist + work.py forward 정정 (Codex M-1) / pytest 38/38 + 회귀 8/8 = 46/46 GREEN / 회귀 위험 0
