...
> **현재 버전**: **v2.15.14 (BUG-SECOND-CLOSE-FORCE-CLOSED-FALSE-POSITIVE + AUDIT TRAIL 통일, 2026-05-15)** — BE only 3 파일 / `auto_close_relay_task` force_closed 인자 추가 + 4개 trigger 함수 영역 unfinished_workers_count 분기 + checklist 경로 영역 trigger_type/closed_by 통일 (Codex 옵션 b) / pytest 38/38 GREEN / 회귀 위험 0
