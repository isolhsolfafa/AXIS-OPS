...
> **현재 버전**: **v2.15.15 (BUG-RELAY-MODE-AUTO-REFRESH-MISSING + COMPLETE-KEY-USELESS, 2026-05-15)** — BE 1 + FE 2 파일 / fetchTasks silent 인자 + 본인 완료 카드 "공정 마감" 버튼 + complete_work and not finalize / 자가 리뷰 M-1+M-2 catch 정정 / pytest 38/38 GREEN / 회귀 위험 0
