...
_ENDPOINT_LABELS = {
    ...
    'work.complete_single_action_route': '단일 작업 완료',
    'work.pause_work': '작업 일시정지',
    'work.resume_work': '작업 재개',
    'work.get_completion_by_serial': '공정 완료 현황',
    'work.get_completion_status': '공정 완료 상태',
    'work.get_active_tasks': '진행중 작업',
    'work.get_pending_tasks': '미종료 작업',
    'work.get_pause_history': '일시정지 이력',
    'work.get_today_tags': '오늘 태깅 이력',
    'work.get_task_corrections': '작업 보정 이력',
    ...
    'auth.resend_verification': '인증 재발송',
    'auth.get_me': '내 정보',
    'auth.refresh': '토큰 갱신',
    ...
    'alert.get_alerts_summary': '알림 요약',
    ...
    'admin.get_settings': '관리자 설정',
    'admin.get_admin_settings': '관리자 설정',
    'admin.update_settings': '설정 변경',
    ...
    'admin.get_attendance_by_date': '날짜별 출퇴근',
    'admin.get_attendance_trend': '출퇴근 추이',
    'admin.initialize_product_tasks': 'Task 초기화',
    'admin.manual_check_unfinished_tasks': '미종료 수동 체크',
    'admin.get_process_summary': '공정 요약',
    ...
    'notices.update_notice': '공지 수정',
    'notices.delete_notice': '공지 삭제',
    # ── production ──
    'production.get_performance': '생산실적',
    'production.confirm_production': '실적 확인',
    'production.cancel_confirm': '실적 확인 취소',
    'production.get_monthly_summary': '월간 실적 요약',
    # ── qr / factory / gst ──
